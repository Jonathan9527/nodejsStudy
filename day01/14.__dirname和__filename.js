...
const abspath = path.join(__dirname, 'files/1.txt') // 今后，只要涉及到路径的拼接，推荐使用 path.join 方法
console.log(abspath)
...
// console.log(__dirname)   //  C:\Users\kang\Desktop\nodejsStudy\day01
// __filename 表示 当前文件的完整路径
// console.log(__filename)   //  C:\Users\kang\Desktop\nodejsStudy\day01\14.fs模块中路径的问题.js
